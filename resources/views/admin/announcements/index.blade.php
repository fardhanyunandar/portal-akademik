        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">Kelola informasi dan pengumuman untuk civitas
                        akademik.</p>
                </div>
            </div>
            <a href="{{ route('admin.announcements.create') }}"
                class="btn btn-primary-custom text-nowrap d-inline-flex align-items-center gap-2">
                <i class="bi bi-plus-circle-fill"></i> Tambah Pengumuman
            </a>
        </div>
                        ...
                        <tbody>
                            @forelse($announcements as $index => $announcement)
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-semibold text-dark text-wrap d-block"
                                            style="max-width: 320px; line-height: 1.4;">
                                            {{ $announcement->title }}
                                        </span>
                                    </td>
                                    <td>
                                        @if ($announcement->target == 'all')
                                            <span
                                                class="badge bg-primary bg-opacity-10 text-primary px-3 py-2">Semua</span>
                                        @elseif($announcement->target == 'students')
                                            <span
                                                class="badge bg-success bg-opacity-10 text-success px-3 py-2">Mahasantri</span>
                                        @else
                                            <span
                                                class="badge bg-warning bg-opacity-10 text-warning px-3 py-2">Dosen</span>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-muted"><i
                                                class="bi bi-calendar2-event me-2"></i>{{ $announcement->created_at->format('d M Y') }}</span>
                                    </td>
                                    <td>
                                        ...
                                        @else
                                            <span
                                                class="badge bg-secondary bg-opacity-10 text-secondary px-3 py-2 rounded-pill"><i
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div
                                            ...
                                            <i class="bi bi-megaphone opacity-25"
