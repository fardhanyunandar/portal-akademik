...
<head>
    ...
    <title>Edit Mahasantri - Portal Akademik PeTIK</title>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="fw-bold mb-0">Edit Mahasantri</h4>
                    <small class="text-muted">Perbarui data mahasantri</small>
                </div>
            </div>
            <a href="{{ route('admin.students.index') }}" class="btn btn-outline-secondary text-nowrap">
        ...
        <div class="card p-4 shadow-sm">
            ...
            <form action="{{ route('admin.students.update', $student->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Password <span class="text-muted small">(kosongkan jika
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="gender" class="form-select" required>
                            ...
                            <option value="male" {{ old('gender', $student->gender) == 'male' ? 'selected' : '' }}>
                                Laki-laki</option>
                            <option value="female"
                                {{ old('gender', $student->gender) == 'female' ? 'selected' : '' }}>Perempuan</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select">
                            <option value="active"
                                {{ old('status', $student->status) == 'active' ? 'selected' : '' }}>Aktif</option>
                            <option value="inactive"
                                {{ old('status', $student->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif
                            </option>
                        </select>
                    </div>
