...
<head>
    ...
    <title>Edit Mata Kuliah - Portal Academic PeTIK</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Edit Mata Kuliah</h3>
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">Perbarui rincian data dan konfigurasi kurikulum modul.</p>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="credits" class="form-select" required>
                            ...
                            @for ($i = 1; $i <= 6; $i++)
                                <option value="{{ $i }}"
                                    {{ old('credits', $course->credits) == $i ? 'selected' : '' }}>{{ $i }} SKS
                                </option>
                            @endfor
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="semester" class="form-select" required>
                            ...
                            @for ($i = 1; $i <= 8; $i++)
                                <option value="{{ $i }}"
                                    {{ old('semester', $course->semester) == $i ? 'selected' : '' }}>Semester {{ $i }}
                                </option>
                            @endfor
                        </select>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="inactive"
                                {{ old('status', $course->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description" class="form-control" rows="4" placeholder="Tuliskan gambaran ringkas silabus atau ruang lingkup bahasan mata kuliah ini (opsional)...">{{ old('description', $course->description) }}</textarea>
                    </div>
