...
<head>
    ...
    <title>Data Dosen - Portal Akademik PeTIK</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Data Dosen</h3>
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">Kelola data seluruh dosen</p>
                </div>
            </div>
            <a href="{{ route('admin.lecturers.create') }}"
                class="btn btn-primary-custom text-nowrap d-inline-flex align-items-center gap-2">
                <i class="bi bi-plus-circle-fill"></i> Tambah Dosen
            </a>
        </div>
                        ...
                        <tbody>
                            @forelse($lecturers as $index => $lecturer)
                                <tr>
                                    ...
                                    <td class="fw-semibold">{{ $lecturer->nip }}</td>
                                    <td>{{ $lecturer->name }}</td>
                                    ...
                                    <td>{{ $lecturer->gender == 'male' ? 'Laki-laki' : 'Perempuan' }}</td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        <div class="py-4">
                                            ...
                                            <p class="mt-3 fw-medium" style="font-size: 1.05rem;">Belum ada data dosen
                                            </p>
                                            <small class="text-muted d-block mt-1">Gunakan tombol di atas untuk
                                                menambahkan modul dosen baru.</small>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
