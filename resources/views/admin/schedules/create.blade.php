...
<head>
    ...
    <title>Tambah Jadwal - Portal Academic PeTIK</title>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <small class="text-muted">Tambah jadwal perkuliahan baru ke dalam sistem</small>
                </div>
            </div>
            <a href="{{ route('admin.schedules.index') }}" class="btn btn-outline-secondary btn-sm px-3 text-nowrap rounded-3">
            ...
            <form action="{{ route('admin.schedules.store') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <select name="course_id" class="form-select py-2 rounded-3" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="lecturer_id" class="form-select py-2 rounded-3" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="day" class="form-select py-2 rounded-3" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="room" class="form-control py-2 rounded-3" value="{{ old('room') }}"
                            placeholder="Contoh: Lab A, Ruang Kelas 02">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Jam Mulai <span class="text-danger">*</span></label>
                        <input type="time" name="start_time" class="form-control py-2 rounded-3"
                            value="{{ old('start_time') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Jam Selesai <span class="text-danger">*</span></label>
                        <input type="time" name="end_time" class="form-control py-2 rounded-3" value="{{ old('end_time') }}"
                            required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Semester <span class="text-danger">*</span></label>
                        <select name="semester" class="form-select py-2 rounded-3" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="academic_year" class="form-select py-2 rounded-3" required>
                            <option value="">-- Pilih Tahun --</option>
                            @for ($y = date('Y'); $y >= date('Y') - 3; $y--)
                                <option value="{{ $y }}"
                                    {{ old('academic_year') == $y ? 'selected' : '' }}>
                                    {{ $y }}/{{ $y + 1 }}</option>
                            @endfor
                        </select>
                    </div>
                    <div class="col-12 mt-4 pt-2 border-top d-flex gap-2">
                        <button type="submit" class="btn btn-primary-custom px-4 py-2 rounded-3">
                            <i class="bi bi-save me-2"></i> Simpan Jadwal
                        </button>
                        <a href="{{ route('admin.schedules.index') }}"
                            class="btn btn-outline-secondary px-4 py-2 rounded-3">Batal</a>
                    </div>
                </div>
            </form>
        </div>
