...
<head>
    ...
    <title>Edit Jadwal - Portal Academic PeTIK</title>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">Perbarui jadwal perkuliahan</p>
                </div>
            </div>
            <a href="{{ route('admin.schedules.index') }}"
            ...
            <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="day" class="form-select" required>
                            ...
                            <option value="thursday" {{ old('day', $schedule->day) == 'thursday' ? 'selected' : '' }}>
                                Kamis</option>
                            <option value="friday" {{ old('day', $schedule->day) == 'friday' ? 'selected' : '' }}>
                                Jumat
                            </option>
                    ...
                    <div class="col-12 mt-5 border-top pt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.schedules.index') }}" class="btn btn-secondary-custom">Batal</a>
                    </div>
                </div>
            </form>
        </div>
