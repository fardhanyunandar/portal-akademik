                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($announcement->target == 'students')
                                            <span
                                                class="badge bg-primary bg-opacity-10 text-primary px-2.5 py-1.5 rounded">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center pe-3">
                                            <a href="{{ route('lecturer.announcements.edit', $announcement->id) }}"
                                                class="btn btn-action btn-outline-primary btn-sm" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <form
                                                action="{{ route('lecturer.announcements.destroy', $announcement->id) }}"
