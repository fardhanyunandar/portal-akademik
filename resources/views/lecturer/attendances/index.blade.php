...
<head>
    ...
    <title>Presensi - Portal Academik PeTIK</title>
    <!-- Fonts -->
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <small class="text-muted">Pilih jadwal untuk mengisi presensi</small>
                </div>
            </div>
        </div>
                    ...
                    <div class="card p-4 h-100 d-flex flex-column justify-content-between">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                @endphp
                                <small class="text-muted d-block mb-1"><i class="bi bi-calendar me-2 text-success"></i>
                                    {{ $days[$schedule->day] }}</small>
                                <small class="text-muted d-block mb-1"><i class="bi bi-clock me-2 text-success"></i>
                                    {{ \Carbon\Carbon::parse($schedule->start_time)->format('H:i') }} -
                                    {{ \Carbon\Carbon::parse($schedule->end_time)->format('H:i') }}</small>
                                <small class="text-muted d-block"><i class="bi bi-geo-alt me-2 text-success"></i>
                                    {{ $schedule->room ?? '-' }}</small>
                            </div>
                        </div>
                        <a href="{{ route('lecturer.attendances.create', ['schedule_id' => $schedule->id, 'date' => date('Y-m-d')]) }}"
                            class="btn btn-primary-custom text-nowrap d-inline-flex align-items-center gap-2">
                            <i class="bi bi-clipboard-check me-2"></i> Isi Presensi
                        </a>
                    </div>
                </div>
            @empty
