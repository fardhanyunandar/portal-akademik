    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Isi Presensi</h3>
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="status-btn btn-present">
                                                <input type="radio" name="attendance[{{ $student->id }}]"
                                                    ...
                                                    {{ ($existing && $existing->status == 'present') || !$existing ? 'checked' : '' }}>
                                            ...
                                            <div class="status-btn btn-sick">
                                                <input type="radio" name="attendance[{{ $student->id }}]"
                                                    id="sick_{{ $student->id }}" value="sick"
                                                    {{ $existing && $existing->status == 'sick' ? 'checked' : '' }}>
                                                <label for="sick_{{ $student->id }}">Sakit</label>
                                            </div>
                                            <div class="status-btn btn-permission">
                                                <input type="radio" name="attendance[{{ $student->id }}]"
                                                    id="permission_{{ $student->id }}" value="permission"
                                                    {{ $existing && $existing->status == 'permission' ? 'checked' : '' }}>
