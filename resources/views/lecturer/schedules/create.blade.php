    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4 gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Tambah Jadwal</h3>
            ...
            <form action="{{ route('admin.schedules.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="room" class="form-control" value="{{ old('room') }}" placeholder="Contoh: Lab A">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="academic_year" class="form-select" required>
                            ...
                            @for($y = date('Y'); $y >= date('Y') - 3; $y--)
                                <option value="{{ $y }}" {{ old('academic_year') == $y ? 'selected' : '' }}>{{ $y }}/{{ $y+1 }}</option>
                            @endfor
                        </select>
                    </div>
