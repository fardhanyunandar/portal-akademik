...
<head>
    ...
    <title>Materi - Portal Akademik PeTIK</title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="main-content">
        <!-- Header Section (Responsif untuk teks & button) -->
        <div
        ...
        <div class="card">
            <div class="card-body p-0">
                <!-- Wrapper Table Responsive agar tabel bisa di-swipe pada layar HP -->
                        ...
                        <tbody>
                            @forelse($materials as $index => $material)
                                <tr>
                                    ...
                                    <td class="fw-semibold">{{ $material->schedule->course->name }}</td>
                                    <td>{{ $material->title }}</td>
                                    <td><span class="badge bg-secondary bg-opacity-10 text-secondary">Pertemuan
                                            {{ $material->meeting_number }}</span></td>
                                    <td>
                                        @if ($material->file_path)
                                            <a href="{{ asset('storage/' . $material->file_path) }}" target="_blank"
                                                class="btn btn-sm btn-outline-primary text-truncate"
                                                style="max-width: 200px;">
                                                <i class="bi bi-download me-1"></i> {{ $material->file_name }}
                                            </a>
                                        @else
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-5 text-muted">
                                        ...
                                        Belum ada berkas materi yang diupload.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
