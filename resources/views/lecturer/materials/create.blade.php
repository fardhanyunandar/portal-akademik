...
<head>
    ...
    <title>Upload Materi - Portal Akademik PeTIK</title>
    <!-- Fonts -->
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Upload Materi</h3>
                    <small class="text-muted">Upload materi perkuliahan baru</small>
                </div>
            </div>
            <a href="{{ route('lecturer.materials.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card p-4">
            ...
            <form action="{{ route('lecturer.materials.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="meeting_number" class="form-control"
                            value="{{ old('meeting_number') }}" min="1" max="16" placeholder="Contoh: 1"
                            required>
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Judul Materi <span class="text-danger">*</span></label>
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}"
                            placeholder="Contoh: Pengenalan Pemrograman Web" required>
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Deskripsi</label>
                        <textarea name="description" class="form-control" rows="3" placeholder="Deskripsi singkat materi (opsional)">{{ old('description') }}</textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">File Materi</label>
                        <input type="file" name="file" class="form-control"
                            accept=".pdf,.doc,.docx,.ppt,.pptx,.xls,.xlsx,.zip">
                        <small class="text-muted">Format: PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, ZIP. Maksimal
                            10MB.</small>
                    </div>
