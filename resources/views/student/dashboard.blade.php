    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Dashboard Mahasantri</h3>
        ...
        <!-- Pengumuman -->
        <div class="card p-4">
            <h6 class="fw-bold mb-3"><i class="bi bi-megaphone me-2" style="color: #1e40af;"></i>Pengumuman Terbaru</h6>
