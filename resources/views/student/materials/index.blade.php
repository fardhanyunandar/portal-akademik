...
<head>
    ...
    <title>Materi - Portal Akademik</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1" style="color: #0f172a;">Materi Kuliah</h3>
                    <small class="text-muted">Materi perkuliahan yang tersedia</small>
                </div>
            </div>
        </div>
        ...
        @forelse($schedules as $schedule)
            @if($schedule->materials->count() > 0)
            <div class="mb-4">
                <h6 class="fw-bold mb-3" style="color:#1e40af;">
                    <i class="bi bi-book me-2"></i>{{ $schedule->course->name }}
                </h6>
                <div class="row g-3">
                        ...
                        <div class="card p-3 h-100 d-flex flex-column justify-content-between">
                            <div>
                                <div class="d-flex align-items-center mb-2">
                                    <div class="p-2 rounded me-2 align-self-start" style="background-color: #eff6ff;">
                                        <i class="bi bi-file-earmark-text" style="color:#1e40af;"></i>
                                    </div>
                                    <div>
                                        <h6 class="fw-bold mb-0 small text-wrap" style="max-width: 180px;">{{ $material->title }}</h6>
                                        <small class="text-muted">Pertemuan {{ $material->meeting_number }}</small>
                                    </div>
                                </div>
                            ...
                            <div class="mt-2">
                                @if($material->file_path)
                                    <a href="{{ asset('storage/' . $material->file_path) }}" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        <i class="bi bi-download me-1"></i> Download
                                    </a>
                                @else
                                    <span class="text-muted small d-block text-center border p-1 rounded bg-light">Tidak ada file</span>
                                @endif
                            </div>
                        </div>
                    </div>
